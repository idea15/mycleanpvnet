...
　　  File "/root/clean-pvnet/lib/config/__init__.py", line 1, in <module>
　　    from .config import cfg, args
　　  File "/root/clean-pvnet/lib/config/config.py", line 1, in <module>
　　    from yacs.config import CfgNode as CN
　　ImportError: No module named yacs.config 
　　解决方案：Requirement already satisfied: yacs in /usr/local/lib/python3.5/dist-packages (0.1.6)
　　Requirement already satisfied: PyYAML in /usr/local/lib/python3.5/dist-packages (from yacs) (5.3.1)
　　在 (base) root@adf8d3ac5ce8:~/clean-pvnet/lib/config# vim config.py
　　添加
　　import sys
　　sys.path.append('/usr/local/lib/python3.5/dist-packagesyacs')
　　import yacs.config
　　（主要的错误是没有在pvnet环境下运行）
